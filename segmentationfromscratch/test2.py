...
from config import EXT_TEST_OUTPUT_DIR, EXT_TEST_PROJECT_NAME, EXT_TEST_CSV
# ✅ Test Transforms
...
def main():
    directory_name = EXT_TEST_OUTPUT_DIR
    ...
    if wandb.run is None:
        wandb.init(project= EXT_TEST_PROJECT_NAME, settings=wandb.Settings(start_method="fork"))
